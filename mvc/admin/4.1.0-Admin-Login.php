        ...
        if($email_count) {
           ...
           // $check_pass = password_verify($loginpassword, $db_pass);
            ...
            if($loginpassword == $db_pass ) {            
                ...
                ?>
                   <script>location.replace("4.2.0-Dashboard.php");</script>
                <?php
            ...
            <div class="main-page-container">
                <div class="form-wrap">
                    ...
                    <div id="form-size" class="main-general-form">
                        <form action="4.1.0-Admin-Login.php" method="post">
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1"
                                    class="form-label">Password</label><a
