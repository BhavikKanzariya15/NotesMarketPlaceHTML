...
<html lang="en">
    ...
    <head>
        ...
        <!-- title -->
        <title>2.2.2-Notes-Details</title>
        <!-- Favicon -->
                        ...
                        <li class="nav-item">
                            <div class="dropdown-profile">
                                ...
                                <div class="dropdown-content-profile">
                                    <a href="3.7.1-User-Profile.php">My Profile</a>
                                    <a href="3.7.2-My-Downloads-Notes.php">My Download</a>
                                    <a href="3.7.3-My-sold-Notes.php">My Sold Notes</a>
                                    <a href="3.7.4-My-Rejected-Notes.php">My Rejected Notes</a>
                                    <a href="3.7.5-Change-Password.php">Change Password</a>
                                    <a href="#">logout</a>
                                </div>
                            </div>
                        </li>
                            ...
                            <div id="Note-Details-Left">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="note-img">
                                            <img
                                                src="images/Notes-Details/1.jpg"
                                                alt="note-image">
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                                        ...
                                        <div class="Note-Detail">
                                            <p>Lorem ipsum dolor sit amet,
                                                consec adipisicing elit.
                                                Doloremque placeat tempora
                                                pariatur ducimus, enim, optio
                                                voluptas aut. Libero dolorem
                                                perspiciatis assumenda provident
                                                ea laudantium unde, veritatis
                                                repudiandae, ducimus obcaecati
                                                aliquam?</p>
                                        </div>
                                        <div class="download-btn">
                                            <a href="#"><button>download /
                                                    <span>$15</span></button></a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-5">
                            ...
                            <div id="Note-Details-Right">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="ml-auto title-value">University
                                        of
                                        California</div>
                                </div>
                                <div class="d-flex">
                                    <div class="mr-auto title">Country:</div>
                                    <div class="ml-auto title-value">United
                                        State</div>
                                </div>
                                <div class="d-flex">
                                    <div class="mr-auto title">Course Name:</div>
                                    <div class="ml-auto title-value">Computer
                                        Science</div>
                                </div>
                                <div class="d-flex">
                                    <div class="mr-auto title">Course Code:</div>
                                    <div class="ml-auto title-value">21408</div>
                                </div>
                                <div class="d-flex">
                                    <div class="mr-auto title">Professor:</div>
                                    <div class="ml-auto title-value">Mr. richard
                                        Brown</div>
                                </div>
                                <div class="d-flex">
                                    <div class="mr-auto title">Number of pages:</div>
                                    <div class="ml-auto title-value">277</div>
                                </div>
                                <div class="d-flex">
                                    <div class="mr-auto title">Approved Date:</div>
                                    <div class="ml-auto title-value">25 Nov,2020</div>
                                </div>
                                <div class="d-flex">
                                    <div class="mr-auto title">Rating</div>
                                    <div class="ml-auto title-value"><div
                                            class="rate">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div id="inappropriate-mark">
                                            <p><span>5 User marked this note as
                            ...
                            <div id="not-preview-left">
                                ...
                                <div id="notes-preview">
                                    <div id="Iframe-Cicis-Menu-To-Go"
                                        class="set-margin-cicis-menu-to-go
                                        ...
                                        <div class="responsive-wrapper
                                            ...
                                            <iframe
                                                ...
                                                <p style="font-size: 110%;"><em><strong>ERROR:
                                                        </strong>
                                                        An &#105;frame should be
                                ...
                                <div id="testmonials">
                                    ...
                                    <div class="testimonial">
                                        <div class="row">
                                            ...
                                            <div>
                                                <p class="testimonial-para">Lorem
                                                    ipsum dolor sit
                                                    amet, consec
                                                    adipisicing elit.
                                                    Expedita unde
                                    ...
                                    <div class="testimonial">
                                        <div class="row">
                                            <div class="col-md-1 col-sm-1">
                                                <div class="customer-img">
                                                    <img class="img-responsive"
                                                        src="images/Notes-Details/client-2.jpg"
                                                        alt="customer-image">
                                                </div>
                                            </div>
                                            <div class="col-md-11 col-sm-11">
                                    ...
                                    <div class="testimonial">
                                        <div class="row">
                                            <div class="col-md-1 col-sm-1">
                                                <div class="customer-img">
                                                    <img class="img-responsive"
                                                        src="images/Notes-Details/client-3.jpg"
                                                        alt="customer-image">
                                                </div>
                                            </div>
                                            <div class="col-md-11 col-sm-11">
